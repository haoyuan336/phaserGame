...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resources = __webpack_require__(299);
	...
	function preload() {
	  ...
	  for (var i in _resources2.default) {
	    game.load.image(_resources2.default[i], _resources2.default[i]);
	  }
	}
	function create() {
	  tileSprite = game.add.tileSprite(0, 0, 1920, 1920, _resources2.default.background_2);
	  game.add.tileSprite(0, 0, 1920, 1920, _resources2.default.background_3);
	  game.add.tileSprite(0, 0, 1920, 1920, _resources2.default.bj1);
	  game.world.setBounds(0, 0, 1920, 1920);
	  game.physics.startSystem(Phaser.Physics.P2JS);
	  player = game.add.sprite(game.world.centerX, game.world.centerY, _resources2.default.dragon_head);
	  game.physics.p2.enable(player);
	  cursors = game.input.keyboard.createCursorKeys();
	  // game.camera.follow(player);
	
	  button = game.add.button(game.world.centerX, game.world.centerY, _resources2.default.direction_2, actionOnClick, this, 2, 1, 0);
	  ...
	  sprite = game.add.sprite(100, 100, _resources2.default.direction_2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameDefines = __webpack_require__(300);
...
/***/ }
/******/ ]);
//# sourceMappingURL=phaserGame.all.js.map